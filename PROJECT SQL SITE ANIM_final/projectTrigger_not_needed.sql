...
create or replace trigger update_employee
	...
	declare
	        ...
	        select eid from employee1 where eid=a;

	        cursor search_employee2(b number) is 
	        select eid from employee2 where eid=b;
	begin
		Eeid:=:old.eid;
		...
		update employee1 set eid=:new.eid where eid=:old.eid;
		...
		update employee2 set eid=:new.eid where eid=:old.eid;
...
create or replace trigger update_employee_salary
	...
	declare
		...
		temp number;
			...
			cursor search_employee1(a number) is 
	        select *from employee1 where eid=a;

	        cursor search_employee2(b number) is 
	        select *from employee2 where eid=b;
	...
	begin
		...
		if(:new.salary>=86500) then
			insert into employee2 (EID,Ename,salary,designation,BID) values(Eeid,Eename,:new.salary,Edesignation,Ebid);
			delete from employee1 where eid=Eeid;
		else
			update employee1 set salary=:new.salary where eid=:old.eid;		
		...
		if(search_employee2%found=true) then
			...
			if(:new.salary<86500) then
			insert into employee1 (EID,Ename,salary,designation,BID) values(Eeid,Eename,:new.salary,Edesignation,Ebid);
			delete from employee2 where eid=Eeid;
		else
			update employee2 set salary=:new.salary where eid=:old.eid;		
	...
	insert on employee  for each row
		begin
			if(:new.salary<86500) then
			insert into employee1 (EID,Ename,salary,designation,BID) values(:new.eid,:new.ename,:new.salary,:new.designation,:new.bid);
			else
			insert into employee2 (EID,Ename,salary,designation,BID) values(:new.eid,:new.ename,:new.salary,:new.designation,:new.bid);
			end if;	
...
create or replace trigger update_employee_designation
	...
	begin
		...
		fetch search_employee1 into Eeid,Eename,Esalary,Edesignation,Ebid;
		if(search_employee1%found=true) then
			update employee1 set designation=:new.designation where eid=:old.eid;		
			end if;	
		close search_employee1;
		...
		fetch search_employee2 into Eeid,Eename,Esalary,Edesignation,Ebid;
		if(search_employee2%found=true) then
			update employee2 set designation=:new.designation where eid=:old.eid;		
			end if;
		close search_employee2;
	end;
...
create or replace trigger delete_employee
	...
	begin
		...
		fetch search_employee1 into Eeid,Eename,Esalary,Edesignation,Ebid;
		if(search_employee1%found=true) then
			delete from employee1 where eid=:old.eid;		
			end if;	
		close search_employee1;
		...
		fetch search_employee2 into Eeid,Eename,Esalary,Edesignation,Ebid;
		if(search_employee2%found=true) then
			delete from employee2 where eid=:old.eid;		
			end if;
		close search_employee2;
	end;
